  ...
  return (
    <div className="md:my-8 my-2 pb-16 rounded-2xl max-w-[1400px] mx-auto bg-background">
      <div className="flex flex-col items-start justify-between w-full">
        <h1 className="md:text-[48px] text-[25px] font-semibold px-10 md:px-20 pt-8 pb-10 md:pt-16 md:pb-20">Що таке мовна адаптація?</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 w-full px-10 md:px-20">
          ...
          <div className="">
            ...
            <h2 className="font-avenir font-semibold text-secondary-gray my-10">Зазвичай це включає:</h2>
